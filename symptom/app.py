...
# TESTING DATA df -------------------------------------------------------------------------------------
    try:
        df_path = "/Users/anish.kumar1/Desktop/symptom-predictor/Training.csv"
        df = pd.read_csv(df_path)
    except FileNotFoundError:
        return jsonify(error=f"File not found: {df_path}")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
    try:
        tr_path = "/Users/anish.kumar1/Desktop/symptom-predictor/Testing.csv"
        tr = pd.read_csv(tr_path)
    except FileNotFoundError:
        return jsonify(error=f"File not found: {tr_path}")
    except Exception as e:
        return jsonify(error=str(e))
